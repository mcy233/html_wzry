...
export const KPL_META_HEROES = {
    '对抗路': ['关羽','马超','花木兰','吕布','夏侯惇','项羽','老夫子','孙策','曜','夏洛特','狂铁','白起','铠','芈月','猪八戒','哪吒','亚连','蒙恬','云缨','刘邦','达摩','盘古','李信','杨戬','司空震','赵怀真','海诺','蚩奼','姬小满'],
    '打野':   ['镜','裴擒虎','澜','李白','云中君','娜可露露','曜','赵云','韩信','橘右京','露娜','兰陵王','阿轲','孙悟空','百里玄策','司马懿','元歌','暃','雅典娜','宫本武藏','大司命','影'],
    '中路':   ['貂蝉','诸葛亮','上官婉儿','嬴政','干将莫邪','不知火舞','司马懿','墨子','嫦娥','西施','武则天','女娲','王昭君','杨玉环','安琪拉','沈梦溪','妲己','海月','弈星','米莱狄','扁鹊','金蝉','周瑜','甄姬','高渐离','张良','姜子牙','芈月'],
    '发育路': ['公孙离','马可波罗','孙尚香','百里守约','后羿','鲁班七号','虞姬','黄忠','伽罗','蒙犽','狄仁杰','李元芳','艾琳','戈娅','莱西奥','敖隐','阿古朵','苍','孙权'],
    '游走':   ['鬼谷子','张飞','太乙真人','牛魔','大乔','蔡文姬','东皇太一','孙膑','瑶','盾山','鲁班大师','明世隐','刘禅','庄周','钟馗','苏烈','桑启','朵莉亚','大禹','少司缘','空空儿'],
};

export const COUNTER_DATA = {
    '廉颇': { counters: ['张良','王昭君'], counteredBy: ['后羿','貂蝉'] },
    '赵云': { counters: ['后羿','鲁班七号'], counteredBy: ['东皇太一','张良'] },
    '关羽': { counters: ['项羽','白起'], counteredBy: ['夏侯惇','花木兰'] },
    '花木兰': { counters: ['关羽','马超'], counteredBy: ['吕布','老夫子'] },
    '马超': { counters: ['花木兰','铠'], counteredBy: ['吕布','狂铁'] },
    '吕布': { counters: ['马超','花木兰'], counteredBy: ['后羿','虞姬'] },
    '镜': { counters: ['后羿','鲁班七号'], counteredBy: ['东皇太一','张飞'] },
    '李白': { counters: ['干将莫邪','嬴政'], counteredBy: ['东皇太一','张良'] },
    '澜': { counters: ['公孙离','马可波罗'], counteredBy: ['张飞','太乙真人'] },
    '貂蝉': { counters: ['廉颇','项羽'], counteredBy: ['诸葛亮','嬴政'] },
    '诸葛亮': { counters: ['貂蝉','露娜'], counteredBy: ['兰陵王','司马懿'] },
    '上官婉儿': { counters: ['嬴政','干将莫邪'], counteredBy: ['东皇太一','钟馗'] },
    '公孙离': { counters: ['伽罗','后羿'], counteredBy: ['镜','澜'] },
    '马可波罗': { counters: ['鲁班七号','后羿'], counteredBy: ['澜','镜'] },
    '鬼谷子': { counters: ['蔡文姬','孙膑'], counteredBy: ['明世隐','东皇太一'] },
    '张飞': { counters: ['镜','澜'], counteredBy: ['鬼谷子','牛魔'] },
    '太乙真人': { counters: ['澜','镜'], counteredBy: ['干将莫邪','嬴政'] },
    '后羿': { counters: ['吕布','廉颇'], counteredBy: ['镜','赵云'] },
    '韩信': { counters: ['后羿','干将莫邪'], counteredBy: ['东皇太一','张良'] },
    '东皇太一': { counters: ['镜','李白','韩信'], counteredBy: ['孙膑','大乔'] },
};
